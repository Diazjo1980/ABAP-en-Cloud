CLASS zcl_datos_biblioteca_2596 DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
  ...
  PRIVATE SECTION.
ENDCLASS.
CLASS zcl_datos_biblioteca_2596 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_catg2596,
          lt_catego    TYPE TABLE OF ztb_catego_2596,
          lt_clientes  TYPE TABLE OF ztb_clientes2596,
          lt_clnts_lib TYPE TABLE OF ztb_clnt_lib2596,
          lt_libros    TYPE TABLE OF ztb_libros_2596.
...
******** ZTB_ACC_CATG2596 ********
    ...
    DELETE FROM ztb_acc_catg2596.
    INSERT ztb_acc_catg2596 FROM TABLE @lt_acc_categ.
...
******** ZTB_CATEGO_2596 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_2596.
    INSERT ztb_catego_2596 FROM TABLE @lt_catego.
...
******** ZTB_CLIENTES2596 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clientes2596.
    INSERT ztb_clientes2596 FROM TABLE @lt_clientes.
...
******** ZTB_CLNT_LIB2596 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clnt_lib2596.
    INSERT ztb_clnt_lib2596 FROM TABLE @lt_clnts_lib.
...
******** ZTB_LIBROS_2596 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_2596.
    INSERT ztb_libros_2596 FROM TABLE @lt_libros.
